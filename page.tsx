...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="min-h-screen flex items-center relative px-6 pt-20 md:pt-0">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-[300px] h-[300px] mx-auto lg:mx-0">
              <TechCircle />
          ...
          >
            <div className="space-y-2">
              <h1 className="text-6xl font-bold tracking-tight bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
                Francisco Gallardo
              </h1>
